...
class DummyJobRepository : JobApplicationRepository {
...
class DummyUserPreferencesRepository : UserPreferencesRepository {
...
fun JobApplicationDetailsScreenPreview() {
    val dummyJobApplicationViewModel = remember {
        JobApplicationViewModel(DummyJobRepository())
            .apply {
